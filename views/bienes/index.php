        ...
        <div class="workData">
            ...
            <div class="formulario">
                <form action="#" method="POST" id="dataItem">
                    <input type="hidden" name="tipo_producto" id="tipo_producto" value="1">
                        ...
                        <div class="datos" id="form1">
                            ...
                            <div class="formbody desactivado">
                                ...
                                <div class="derecha">
                                    ...
                                    <div class="divInfo">
                                        <label for="grupo" class="w15p">Clase :</label>
                                        <input type="text" name="clase" id="clase" class="desactivado">
                                        <span id="nombre_clase">---</span>
                                    </div>
                                    <div class="divInfo">
                                        <label for="grupo" class="w15p">Familia :</label>
                        ...
                        <div class="datos" id="form2">
                            <div class="formbody desactivado">
                                <div class="izquierda">
                                    ...
                                    <div class="divInput">
                                        <label for="marca" class="w250px">Marca :</label>
                                        <input type="text" name="marca" id="marca" class="mayusculas w50p">
                                    </div>
                                    <div class="divInput">
                                        <label for="modelo" class="w250px">Modelo :</label>
                                        <input type="text" name="modelo" id="modelo" class="mayusculas w50p">
                                    </div>
                                    <div class="divInput">
                                        <label for="medida" class="w250px">Medida :</label>
                                        <input type="text" name="medida" id="medida" class="mayusculas w50p">
                                    </div>
                                    <div class="divInput">
                                        <label for="color" class="w250px">Color :</label>
                                        <input type="text" name="color" id="color" class="mayusculas w50p">
                                    </div>
                                    <div class="divInput">
                                        <label for="Peso" class="w250px">Peso :</label>
                                        <input type="number" name="peso" id="peso" class="mayusculas w50p">
                                    </div>
                                    <div class="divInput">
                                        <label for="volumen" class="w250px">Volumen :</label>
                                        <input type="number" name="volumen" id="volumen" class="mayusculas w50p">
                                    </div>
                                    <div class="divInput">
                                        <label for="nro_parte" class="w250px">Nro. Parte :</label>
                                        <input type="text" name="nro_parte" id="nro_parte" class="mayusculas w50p">
                                    </div>
                                </div>
                                <div class="derecha">
                                    <div class="divInput">
                                        <label for="cod_anexo" class="w250px">Cod. Anexo :</label>
                                        <input type="text" name="cod_anexo" id="cod_anexo" class="mayusculas w50p">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="datos" id="form3">
                            <a href="#" class="floatingButton desactivado" title="Adjuntar Imagen" id="uploadPhoto"><i class="fas fa-camera-retro"></i></a>
                            <div class="formbody desactivado">
                                <div class="izquierda">
                                ...
                                <div class="derecha">
                                    <div class="foto">
                                        <img id="img_preview" src="<?php echo constant('URL')?>public/img/noimagen.jpg">
                                    </div>
                                </div>
                            </div>
                        </div>
