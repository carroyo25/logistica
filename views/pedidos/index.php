                ...
                <div class="descrip_title">
                    ...
                    <div>
                        ...
                        <button type="button" id="sendItem" title="Enviar Pedido">
                            <i class="far fa-paper-plane"></i> Enviar Pedido
                        </button>
                    </div>
                </div>
                    ...
                    <div class="details_item">
                        ...
                        <div class="w35p">
                            <table class="con_borde w100p" id=stock_table>
                                <thead>
                                    <tr>
                                        <th class="w40p">Ubicación.</th>
                                        <th class="w15p">Und</th>
                                        <th class="w15p">Cant.</th>
                                    </tr>
                                </thead>
                                <tbody>
