...
<body>
                        ...
                        <div class="datos" id="form1">
                            <div class="datainputs">
                                <div class="inputfield">
                                    <label for="codigo_area" class="w250px">Código</label>
                                    <input type="text" name="codigo_area" id="codigo_area" class="desactivado">
                                </div>
                                <div class="inputfield">
                                    <label for="descripcion_area" class="w250px">* Descripción :</label>
                                    <input type="text" name="descripcion_area" id="descripcion_area" class="w40p mayusculas">
                                </div>
                                <hr>
                            </div>
                           <?php 
    ...
    <script src="<?php echo constant('URL');?>public/js/areas.js?<?php echo constant('VERSION')?>"></script>
