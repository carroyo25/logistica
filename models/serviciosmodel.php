     ...
     class ServiciosModel extends Model{
        ...
        public function insert($datos) {
            try {
                ...
                $query = $this->db->connect()->prepare("INSERT INTO cm_producto (cdesprod,cdescomer,cdesabrev,ccodprod,ncodcata,ncodsunat,ccodbarra,mdetalle,
                                                                                ntipoorig,ntipodest,nunidsec,nloteprod,nserieprod,ndigemid,ngasrela,nicbper,nregesp,ncodmed,
                                                                                nflgactivo,ntipoprod,id_cprod)
                                                                        VALUES(:derc,:ncom,:ncor,:codi,:ccat,:prsu,:codb,:deta,
                                                                               :orig,:dest,:unse,:lote,:srun,:cond,:prre,:afic,:rees,:coun,
                                                                               :esta,:tipr,:ncod)");
        ...
        public function listItems() {
            try {
                ...
                $query  = $this->db->connect()->query("SELECT
                                    ...
                                    FROM
                                    cm_producto
                                    WHERE cm_producto.nflgactivo = '1' AND  cm_producto.ntipoprod = '2'
                                    ORDER BY
